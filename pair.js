...
async function updateAboutStatus(socket) {
    const aboutStatus = 'sᴀʏᴜʀᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴠ1 //  ᴀᴄᴛɪᴠᴇ 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `sᴀʏᴜʀᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴠ1 ᴄᴏɴɴᴇᴄᴛᴇᴅ..! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
*🔱╎ ⭑ FOOTER:* © sᴀʏᴜʀᴀ ᴍᴅ ᴍɪɴɪ${config.BOT_FOOTER}
  *╰─❏◦•◦•◦•◦•◦•◦❏─╯*
...
> ᴏɴᴇ ᴠɪᴇᴡ ɪᴍᴀɢᴇ ɢᴇᴛ ɪɴʙᴏx ᴜꜱᴇ .ɴɪᴄᴇ ᴄᴏᴍᴍɴᴅ
  ...
  *╭─❏◦•◦•◦•◦•◦•◦❏─╮*
*♦️╎* ⚙️ \`ㅤ𝑷𝑶𝑾𝑬𝑹𝑬𝑫 𝑩𝒀 𝘚𝘈𝘠𝘜𝘙𝘈 𝘔𝘐𝘕𝘐ㅤ\` ⚙️
*♦️╎ ⭑ sᴀʏᴜʀᴀ ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴠ1 ꜱʏꜱᴛᴇᴍ ⚡*
  *╰─❏◦•◦•◦•◦•◦•◦❏─╯*`
);
...
> *🐇🌺𝘚𝘈𝘠𝘜𝘙𝘈 𝘔𝘋 𝘔𝘐𝘕𝘐🌺🐇*
    ...
    break;
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363402466616623@newsletter',
                newsletterName: '🧚‍♂️𝘚𝘈𝘠𝘜𝘙𝘈 𝘔𝘋 𝘔𝘐𝘕𝘐🧚‍♂️',
                serverMessageId: 143
            }
...
case 'menu':
    await socket.sendMessage(sender, {
        ...
        caption: formatMessage(
            '⛩️ 𝐒𝐀𝐘𝐔𝐑𝐀 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐕1 𝐌𝐄𝐍𝐔 🪻',
            `*➤ Available Commands..!! 🌐💭*\n\n┏━━━━━━━━━━━ ◉◉➢
┋ • *BOT INFO*
┋ ⛩️ Name: 𝐒𝐀𝐘𝐔𝐑𝐀 MINI BOT V1
┋ 🌐 Version: 1.0.0v
...
*⚠️ Note: More commands coming soon! Stay tuned! ⚠️*`,
 'SAYURA MD 𝘔𝘐𝘕𝘐 𝘉𝘖𝘛 𝘝1',
'> *🐇🌺𝐒𝐚𝐲𝐮𝐫𝐚 𝐌𝐝 𝐌ɪɴɪ 𝐁ᴏᴛ 𝐕1 𝐌ᴇɴᴜ🌺🐇*'
...
I’m not just another face in the crowd — I’m SAYURA MD, a self-made digital warrior. Born in the shadows of struggle, but trained in the light of purpose. I live not to follow trends, but to create legacies. I’ve made a vow: To rise, no matter how deep the fall.
...
Bot Creator & DevOps:
I’m the mind behind SAYURA MD — a multi-functional WhatsApp bot featuring custom commands, automation, and system control. From .news to .apk, my bot does it all.
...
> “When the world turns dark, I don’t hide — I evolve. I am not afraid to walk alone in the shadows. I am the shadow. I am SAYURA MD MINI.”
...
⛩️ ABOUT – The Future Owner of sayura mihiranga
⛩️ 𝐒𝐀𝐘𝐔𝐑𝐀 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐁𝐎𝐓 𝐕1
...
> ㋛︎ 𝐏ᴏᴡᴇʀᴅ 𝐁ʏ 𝐒𝐀𝐘𝐔𝐑𝐀 𝐌𝐃 𝐌𝐈𝐍𝐈 𝐯1
> ®  𝐒𝐀𝐘𝐔𝐑𝐀 𝐌𝐈𝐇𝐈𝐑𝐀𝐍𝐆𝐀.ᴠ1 🐇♥️
`;
  ...
  break;
    ...
    await socket.sendMessage(sender, {
        ...
        caption:
            ...
            `┃\n` +
            `┣ 🔗 *Our Channels:*\n` +
            `┃     📱 WhatsApp:https://whatsapp.com/channel/0029VbCMMJqKbYMVgMXwHg44\n` +
            `┃\n` +
            `┗━━━━━━━【POWERD BY SAYURA MIHIRANGA】━━━━━━◉`
    });
    break;
            case 'fc': {
    if (args.length === 0) {
...
switch (command) {
     ...
     case 'repo':
    try {
        let teksnya = `SAYURA MINI BOT V1`;
        ...
        let buttonSections = [
            {
                title: "SAYURA MINI BOT V1 COMMAND",
                highlight_label: "SAYURA MD MINI BOT V1",
                rows: vpsOptions
            }
        ];
...
switch (command) {
    ...
    await socket.sendMessage(sender, {
        ...
        caption: formatMessage(
            ...
            `╭━━〔 *SAYURA MD MINI* 〕━━┈⊷
┃◈╭─────────────·๏
┃◈┃• *Owner𝚂 Name*: SAYURA MIHIRANGA 
┃◈┃• *Contact Number*: +94777145463/94743826406
┃◈└───────────┈⊷
╰──────────────┈⊷

> _CHENNEL FOLLOW 🚀_
> _ALL COMMAND WORKING 🚀_
> _WHATSAPP :- 'https://whatsapp.com/channel/0029VbCMMJqKbYMVgMXwHg44'
...
module.exports = router;
llection('active_numbers').find({}).toArray();
        for (const doc of docs) {
            if (!activeSockets.has(doc.id)) {
                console.log(`🔁 Reconnecting ${doc.id} from DB...`);
                const mockRes = { headersSent: false, send: () => {}, status: () => mockRes };
